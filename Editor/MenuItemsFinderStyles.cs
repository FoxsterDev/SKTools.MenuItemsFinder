...
namespace SKTools.MenuItemsFinder
{
    ...
    internal class MenuItemsFinderStyles : ScriptableObject
    {
        ...
        [SerializeField]
        private Color _itemDefaultColor = Color.white;

        [SerializeField]
        private Color _itemMissedColor = Color.red;

        [SerializeField]
        private Color _itemNotExecutableColor = Color.gray;

        [SerializeField]
        private Color _itemSelectedContentColor = Color.yellow;

        [SerializeField]
        private Color _itemHotKeyColor = Color.cyan;
